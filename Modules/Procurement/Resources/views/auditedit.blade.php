...
@section('content')
    <div class="container">
        <div class="card">
            ...
            @unless ($data->status == 4)


                <div class="card-footer">
                    <form action="{{ route('auditp.save', [$data->id]) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label class=" form-label" for=""> ADD COMMENT AS THE HOD AUDIT</label>
                                <input type="text" name="audit_comment" class=" form-control form-input" id="">
                            </div>
                            <div class="form-group">
                                <button type="submit" name="status" value="0" class="btn btn-danger">Decline</button>
                                <button type="submit" name="status" value="4"
                                    class="btn btn-success">Authorize</button>
                            </div>
                        </div>
                        {{-- @endif
                        @endforeach --}}
