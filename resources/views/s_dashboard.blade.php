...
<style>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl ">
            <h5 class="text-center mb-7">OVERVIEW</h5>
            <h1 class="text-center text-primary mb-5 text-uppercase" style="display: none;"><span class=" text-uppercase">
                    ...
                    <ul class="nav nav-tabs bg-primary" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="letter1-tab" data-toggle="tab" href="#letter1" role="tab"
                                aria-controls="letter1" aria-selected="true">Incoming Letter</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade show active" id="letter" role="tabpanel" aria-labelledby="letter-tab">
                            <div class="row g-5 g-xl-8">
                                <div class="row">
                                    ...
                                    --}}
                                        <input type="hidden" id="deptSelect1"
                                            value="{{ auth()->user()->staff->department_id }}" />
        ...
        $sum += $item['price'];
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)"
                                                                        onclick="confirmApproval('{{ route('approve_demand_notice', $service_application->id) }}')"
                                    ...
                                    <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"
                                                id="pending_application_forms"></div>
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!--end::Svg Icon-->
                                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5" id="pending_inspections">
                                            </div>
