            ...
            <div class="col-lg-4 col-10 ml-3">
                <div class="form-group">
                    <div class="form-control-wrap">
                        ...
                        <select required class="form-control" name="processing_type_id" id="processing_type_id">
         ...
         <div class="col-lg-4 col-10 ml-4">
            <div class="form-group">
                <div class="form-control-wrap">
                    ...
                    <label class="form-label-outlined" for="name">Monitoring Fee Name</label>
                    <input required type="text" class="form-control form-control-xl form-control-outlined"
                        id="name" name="name" value="{{old('name', $monitoring_fee->name ?? '')}}">
        ...
        <div class="col-lg-4 col-10 ml-4">
            <div class="form-group">
                <div class="form-control-wrap">
                    ...
                    <label class="form-label-outlined" for="amount">Monitoring Fee</label>
                    <input required type="number" class="form-control form-control-xl form-control-outlined"
                        id="amount" name="amount" value="{{old('amount', $monitoring_fee->amount ?? '')}}">
