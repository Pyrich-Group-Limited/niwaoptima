                                ...
                                @foreach ($tasks as $task)
                                    <tr>
                                        <td>
                                            ...
                                            <span class="d-flex text-sm text-muted justify-content-between">
                                                ...
                                                <span
                                                    class="me-5 badge p-2 px-3 rounded bg-{{ \Auth::user()->checkProject($task->project_id) == 'Owner' ? 'success' : 'warning' }}">
                                            ...
                                            <div class="avatar-group">
                                                            ...
                                                            @if ($key < 3)
                                                                <a href="#"
                                                                    ...
                                                                    <img data-original-title="{{ !empty($user) ? $user->name : '' }}"
                                                                        ...
                                                                        title="{{ $user->first_name }}" class="hweb">
                                                                </a>
                                                            @else
                                                            @break
                                                        @endif
                                                ...
                                                @if (count($users) > 3)
                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                        <img data-original-title="{{ !empty($user) ? $user->first_name : '' }}"
                                                            @if ($user->avatar) src="{{ asset('/storage/uploads/avatar/' . $user->avatar) }}" @else src="{{ asset('/storage/uploads/avatar/avatar.png') }}" @endif
                                                            class="hweb">
                                                    </a>
                                                @endif
                                    ...
                                    <td>
                                        ...
                                        <div class="align-items-center">
                                            <span
                                                class="completion">{{ $task->taskProgress()['percentage'] }}</span>
                                            <div class="progress">
                                                <div class="progress-bar bg-{{ $task->taskProgress()['color'] }}"
                                                    role="progressbar"
