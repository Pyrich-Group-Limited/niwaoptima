                                                  ...
                                                  <tbody>
                                                      ...
                                                      @foreach ($service_applications as $index => $service_application)
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td>{{ $service_application->theservice ? $service_application->theservice->name : '' }}</td>
...
<td>
{{ isset($service_application->demand_total) ? '₦'. number_format($service_application->demand_total, 2) : 'N/A' }}
</td>
